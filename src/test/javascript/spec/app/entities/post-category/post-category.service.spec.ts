...
describe('Service Tests', () => {
  describe('PostCategory Service', () => {
    let injector: TestBed;
    let service: PostCategoryService;
    let httpMock: HttpTestingController;
    let elemDefault: IPostCategory;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(PostCategoryService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new PostCategory(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a PostCategory', async () => {
      ...
      it('should return a list of PostCategory', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB'
          },
