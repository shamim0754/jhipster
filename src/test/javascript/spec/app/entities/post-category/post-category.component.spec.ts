...
import { PostCategoryComponent } from 'app/entities/post-category/post-category.component';
...
describe('Component Tests', () => {
  describe('PostCategory Management Component', () => {
    let comp: PostCategoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PostCategoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.postCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
